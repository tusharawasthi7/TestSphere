...
public class TestHistoryRowMapper implements RowMapper<Test> {
	...
	@Override
			public Test mapRow(ResultSet rs, int rowNum) throws SQLException {
				...
				return new Test(catalogName,testId,noOfQuestions,startTime,endTime,adminID,name,status,date,list_of_questions,level,type);
