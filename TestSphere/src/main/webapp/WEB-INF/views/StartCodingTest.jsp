...
<%@ page
	import="java.util.List, java.util.Collections, java.util.Comparator"%>
...
.left {
	width: 75%; /* 9 units */
	padding: 20px;
	background-color: #ffffff; /* White background for left section */
	display: flex;
	flex-direction: column; /* Flex for vertical alignment */
	overflow-y: auto;
}
	...
	<div class="container">
		<div class="left">
			<div id="instructions" class="instructions">
				<marquee behavior="scroll" direction="left"> Attention:
					Switching tabs will automatically submit your test. Please ensure
					you stay on this page until you complete the test. </marquee>
			</div>
			<%
